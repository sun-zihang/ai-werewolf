...
function replaceX(s, aliveIds) {
    const x = pick(aliveIds);
    return s.replaceAll("X 号", `${x} 号`);
}
export function localSpeech(input) {
...
export function fallbackSpeech(input) {
