import { DecisionInput, Role, ROLE_LABEL, TEAM_LABEL, ThinkingLevel } from "../types.js";
import { thinkingInstruction } from "./adapters.js";

// 按角色 + 强度动态加载的策略库
const STRATEGY: Record<Role, Record<ThinkingLevel, string>> = {
  werewolf: {
...
export function buildMessages(input: DecisionInput): { system: string; user: string } {
